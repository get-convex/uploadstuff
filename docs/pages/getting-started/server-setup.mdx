...
We'll be using [Convex](https://convex.dev) to implement our file storage, but you could use any means of generating an upload URL, as long as you can authorize it.

## Setting up Convex functions for file upload

We'll use 2 [mutations](https://docs.convex.dev/functions/mutation-functions): The first one generates an upload URL, the second one saves the file storage ID in our database.
...
The second endpoint will be called after the file upload
is complete, to save the uploaded files' storage IDs
and any metadata in our database. It can also:
...
In your project you can give these mutations more specific names based on your use case,
and you can create multiple pairs of mutations for different file uploading use cases
you might have in your app.
