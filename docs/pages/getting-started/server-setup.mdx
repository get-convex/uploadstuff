...
We'll be using [Convex](convex.dev) to implement our file storage, but you could use any means of generating an upload URL, as long as you can authorize it.
