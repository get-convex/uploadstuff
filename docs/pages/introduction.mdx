...
You can't let just anyone upload files to a storage provider which you pay for. You should authorize upload on the server. [Convex](convex.dev) makes this really easy.
